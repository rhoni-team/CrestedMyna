    ...
    operations = [
        migrations.RunSQL(
            ...
            UPDATE data_loading_citiesacexotic
                SET buffer_radio = ROUND(CAST(20000 + ((population::float / 20000000) * (150000 - 20000)) AS INTEGER), 0);
            ...
            CREATE OR REPLACE VIEW dissolved_cities_buffers_view AS
            SELECT
                iso2,
            ...
            FROM dissolved_cities_buffers_view;

            -- Drop the view
            DROP VIEW dissolved_cities_buffers_view;
            """
        )
    ]
